...
employee_dataframe=pd.read_csv('C:\\Users\\kp\\Pictures\\Assignments\\Simple Linear Regression\\emp_data.csv')
#TO derive the number of rows and columns the given data set has
print(employee_dataframe.shape)

#Assigning the columns and labels to X,Y
X=employee_dataframe['Salary_hike'].values.reshape(-1, 1)
y=employee_dataframe['Churn_out_rate'].values.reshape(-1, 1)
